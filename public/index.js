...
function getAllInf() {
    getData("GET", "http://120.79.70.187:3000/contacts", null, function() {
...
function deleteInf(event) {
    ...
    getData("DELETE", "http://120.79.70.187:3000/contacts/" + obj.parentNode.parentNode.getAttribute('id'), null, function() {
        if (xmlhttp.readyState == 4) {
            if (xmlhttp.status == 200) {
